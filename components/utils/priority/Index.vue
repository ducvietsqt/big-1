...
<script>
    export default {
        data() {
            return {
                list: [
                    {title: 'High', color: '#f5365c', id: 23454, icon_num: 3},
                    {title: 'Medium', color: '#ffbb33', id: 7485236, icon_num: 2},
                    {title: 'Low', color: '#5e72e4', id: 748522536, icon_num: 1},
                    {title: 'None', color: '#37474f', id: 748524336, icon_num: 3},
                ]
            }
        },
        props: ["value"],
