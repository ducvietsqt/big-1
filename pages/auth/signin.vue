    ...
    <v-form v-else ref="form" @submit.prevent="submit" lazy-validation class="form_auth">
      ...
      <div class="px-0">
        ...
        <div class="subheading mt-3">
          Or,
          <nuxt-link class="link_bt" to="/auth/create-workspace">Create a new workspace?</nuxt-link>
        </div>
      </div>
    </v-form>
    <div v-if="notExistSubdomain">
      <h4 class="auth-header mb-4 font-weight-bold text-primary caption text-xs-left error--text">
